  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
      <div className="w-full max-w-md apple-glass p-10 rounded-3xl text-center relative overflow-hidden">
        ...
        <h2 className="text-2xl font-bold text-slate-800 mb-4">Account Pending</h2>
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 w-full py-3 bg-white border border-slate-200 text-slate-800 rounded-xl font-medium hover:bg-white/5 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500/50"
        >
